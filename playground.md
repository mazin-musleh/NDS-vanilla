...
<!-- Compliance Ready (scroll-more variant) -->
<section id="compliance" class="nds-content-section">
    ...
    <div class="nds-section-body">
        <div class="nds-scroll-more">
            <div class="nds-scroll-more-content nds-grid" style="--max-col: 6; --min-width: 320px;">
...
<section class="nds-content-section">
    <div class="nds-section-wrapper">
        <div class="nds-section-head">
            <h2 class="nds-section-title">Scroll More — Vertical</h2>
            <p class="nds-section-description">A tall list constrained by <code>--scroll-max-height</code>.</p>
        </div>
        <div class="nds-section-body">
            <div class="nds-scroll-more nds-divided" style="--scroll-max-height: 320px; --scroll-max-width: 480px;">
