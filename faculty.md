        ...
        <div class="nds-section-content">
            <dl class="nds-definition-list tableView nds-divided" style="--max-col:4;--mid-col:2;--min-col:2;">
                ...
                <div class="nds-definition-item">
                    ...
                    <dd>الذكاء الاصطناعي وتعلم الآلة</dd>
                </div>
            </dl>
        </div>
    </div>
    ...
    <div class="nds-section-content">
        <div class="nds-tabs nds-divided nds-lg">
            <div class="nds-tab-list-container">
                <nav class="nds-tab-list" role="tablist" aria-label="معلومات عضو هيئة التدريس">
            ...
            <div class="nds-tab-content">
                ...
                <div class="nds-tab-panel nds-card nds-shadow" role="tabpanel" id="panel-cv" aria-labelledby="tab-cv"
                    ...
                    <div class="nds-content-block">
                        ...
                        <p>قام بالإشراف على أكثر من 30 رسالة ماجستير ودكتوراه، وشارك في العديد من المشاريع البحثية
                            الممولة
                            محلياً ودولياً. كما يشغل منصب رئيس وحدة البحوث والابتكار في القسم.</p>
                    </div>
                </div>
                ...
                <div class="nds-tab-panel nds-card nds-shadow" role="tabpanel" id="panel-education"
                    ...
                    <div class="nds-content-block">
                        ...
                        <div class="nds-definition-item">
                            <dt><span class="label">الماجستير</span></dt>
                            <dd>علوم الحاسب - جامعة الملك عبدالعزيز، المملكة العربية السعودية (2006)</dd>
                        </div>
                        <div class="nds-definition-item">
