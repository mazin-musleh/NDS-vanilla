...
- **Phase 3 done:** radio (527a6540), checkbox (a4017098), chips (115b7de1), tags. Component fixes found on the way: readonly checkbox/radio/switch keyboard guard + disabled label color (66d6f349), button width fit-content (34310c9f), button group/progress/status (1ecd2ab4), chip width + disabled icon + no opacity (d132f059), tag width + ghost text on color (ee19e26e).
...
- **Next page:** featured-icons. Then link, content-switcher, persona, toolbar (see the tracker in `TODO.md`).
