...
<section id="templates" class="nds-content-section">
    <div class="nds-section-wrapper">
        ...
        <div class="nds-section-body">
                ...
                <div class="nds-dropmenu nds-filter" data-filter-target="templates_list">
                    ...
                    <div class="nds-dropmenu-menu" style="min-width: 300px;" hidden>
                        <div class="nds-dropmenu-scroll">
                            ...
                            <div data-filter="feature" data-filter-legend="Features" data-filter-type="checkbox"
                                data-no-auto-close></div>
                        </div>
            ...
            <div id="templates_list" class="nds-paged-content nds-grid"
            ...
            <nav class="nds-pagination" data-auto-pagination="templates_list" aria-label="Pagination"></nav>
        </div>
    </div>
</section>
