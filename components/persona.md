        ...
        <div class="nds-section-body">
            ...
            <div class="nds-block">
                ...
                <ul>
                    ...
                    <li>Override only the token you need via a CSS custom property rather than writing additional SCSS. For example, <code class="nds-inline-code lang-html">--persona-name-color: var(--text-primary-strong)</code> highlights the name on a themed surface without affecting the other slots</li>
