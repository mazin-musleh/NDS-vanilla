            ...
            <div class="nds-block">
                ...
                <table class="nds-table nds-responsive">
                    ...
                    <tbody>
                        ...
                        <tr><td><code class="nds-inline-code lang-html">--bullet-active</code></td><td><code class="nds-inline-code lang-html">var(--colors-primary-600)</code></td><td>Active pagination bullet color (light theme); shifts to green-600 in dark mode and to base white on hero/on-color backgrounds</td></tr>
                        <tr><td><code class="nds-inline-code lang-html">--bullet-active-hover</code></td><td><code class="nds-inline-code lang-html">var(--colors-primary-700)</code></td><td>Active bullet hover color (one step darker: primary-700 light, green-700 dark)</td></tr>
