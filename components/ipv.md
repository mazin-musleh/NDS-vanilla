    ...
    <div class="nds-section-wrapper">
        ...
        <div class="nds-section-content">
            <div class="nds-definition-list nds-divided nds-grid" style="--max-col:2;--mid-col:1;--min-col:1;">
                ...
                <div class="nds-definition-item">
                    <span class="nds-item-title">
                        <i class="hgi hgi-stroke hgi-zoom icon"></i>
                        <span class="label">Multi-input Zoom</span>
                    </span>
                ...
                <div class="nds-definition-item">
                    <span class="nds-item-title">
                        <i class="hgi hgi-stroke hgi-move icon"></i>
                        <span class="label">Drag to Pan</span>
                    </span>
                ...
                <div class="nds-definition-item">
                    <span class="nds-item-title">
                        <i class="hgi hgi-stroke hgi-arrow-left-right icon"></i>
                        <span class="label">Gallery Navigation</span>
                    </span>
                ...
                <div class="nds-definition-item">
                    <span class="nds-item-title">
                        ...
                        <span class="label">Keyboard Controls</span>
                    </span>
                ...
                <div class="nds-definition-item">
                    <span class="nds-item-title">
                        <i class="hgi hgi-stroke hgi-touch-interaction-01 icon"></i>
                        <span class="label">Touch Gestures</span>
                    </span>
                ...
                <div class="nds-definition-item">
                    <span class="nds-item-title">
                        ...
                        <span class="label">Distraction-free Mode</span>
                    </span>
                ...
                <div class="nds-definition-item">
                    <span class="nds-item-title">
                        ...
                        <span class="label">Adaptive Image Loading</span>
                    </span>
