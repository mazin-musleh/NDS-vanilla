                                ...
                                <div class="nds-tabs">
                                    <div class="nds-tab-list-container">
                                        ...
                                        <button class="nds-btn nds-subtle nds-tab" role="tab" aria-selected="true"
                                            ...
                                            <span class="nds-label">Tab 1</span>
                                        </button>
                                        <button class="nds-btn nds-subtle nds-tab" role="tab" aria-selected="false"
                                            aria-controls="panel-2" id="tab-2" tabindex="-1">
                                            <span class="nds-label">Tab 2</span>
                                        </button>
                                        </nav>
                    ...
                    <div class="nds-tabs" id="iconTabs" hidden>
                        ...
                        <div class="nds-tab-content">
                            ...
                            <div class="nds-tab-panel" role="tabpanel" id="panel-analytics"
                                ...
                                <div class="nds-form-container nds-select">
                                    <div class="nds-form-header">
                                        <label class="nds-label" for="analyticsPeriod">Analytics Period</label>
                                    </div>
                                ...
                                <fieldset>
                                    <legend class="nds-label">Data to Include</legend>
                                    <div class="nds-form-group nds-check-group">
                                        <div class="nds-form-container nds-check-container">
                                            <div class="nds-form-header">
                                                <label class="nds-label" for="includeUsers">User Activity</label>
                                            </div>
                                            <div class="nds-form-control">
                                        ...
                                        <div class="nds-form-container nds-check-container">
                                            <div class="nds-form-header">
                                                <label class="nds-label" for="includePerformance">System Performance</label>
                                        ...
                                        <div class="nds-form-container nds-check-container">
                                            <div class="nds-form-header">
                                                <label class="nds-label" for="includeServices">Service Usage</label>
                                            </div>
                                            <div class="nds-form-control">
                                        ...
                                        <div class="nds-form-container nds-check-container">
                                            <div class="nds-form-header">
                                                <label class="nds-label" for="includeErrors">Error Reports</label>
                                            </div>
                                            <div class="nds-form-control">
                            ...
                            <div class="nds-tab-panel" role="tabpanel" id="panel-settings"
                                ...
                                <div class="nds-form-container nds-select">
                                    <div class="nds-form-header">
                                        <label class="nds-label" for="languageSelect">Language Preference</label>
                                    </div>
                                    <div class="nds-form-control">
                                ...
                                <!-- Theme Preference -->
                                <fieldset>
                                    <legend class="nds-label">Theme Preference</legend>
                                    <div class="nds-form-group nds-radio-group">
                                        <div class="nds-form-container nds-radio-container">
                                            <div class="nds-form-header">
                                                <label class="nds-label" for="themeLight">Light Theme</label>
                                            </div>
                                            <div class="nds-form-control">
                                        ...
                                        <div class="nds-form-container nds-radio-container">
                                            <div class="nds-form-header">
                                                <label class="nds-label" for="themeDark">Dark Theme</label>
                                            </div>
                                            <div class="nds-form-control">
                                        ...
                                        <div class="nds-form-container nds-radio-container">
                                            <div class="nds-form-header">
                                                <label class="nds-label" for="themeAuto">Auto (System)</label>
                                ...
                                <fieldset>
                                    <legend class="nds-label">Notification Settings</legend>
                                    <div class="nds-form-group nds-check-group">
                                        <div class="nds-form-container nds-check-container">
                                            <div class="nds-form-header">
                                                <label class="nds-label" for="emailNotifications">Email
                                                    Notifications</label>
                                            </div>
                                            <div class="nds-form-control">
                                        ...
                                        <div class="nds-form-container nds-check-container">
                                            <div class="nds-form-header">
                                                <label class="nds-label" for="smsNotifications">SMS Notifications</label>
                                            </div>
                                            <div class="nds-form-control">
                                        ...
                                        <div class="nds-form-container nds-check-container">
                                            <div class="nds-form-header">
                                                <label class="nds-label" for="pushNotifications">Push Notifications</label>
    ...
    <div class="nds-section-wrapper">
        ...
        <div class="nds-section-body">
                <div class="nds-content-block">
                    ...
                    <dl class="nds-definition-list nds-tableView">
                        <div class="nds-definition-item">
                            <dt><span class="nds-label">&lt;nav&gt; element</span></dt>
                            <dd>Semantic navigation wrapper for the tab list</dd>
                        </div>
                        <div class="nds-definition-item">
                            <dt><span class="nds-label">role="tablist"</span></dt>
                            <dd>Applied to the nav element containing tab buttons</dd>
                        </div>
                        <div class="nds-definition-item">
                            <dt><span class="nds-label">role="tab"</span></dt>
                            <dd>Applied to each individual tab button</dd>
                        </div>
                        <div class="nds-definition-item">
                            <dt><span class="nds-label">role="tabpanel"</span></dt>
                ...
                <div class="nds-content-block">
                    ...
                    <dl class="nds-definition-list nds-tableView">
                        <div class="nds-definition-item">
                            <dt><span class="nds-label">aria-hidden="true"</span></dt>
                            <dd>Informs screen readers that the content is hidden and should be ignored</dd>
                        </div>
                        <div class="nds-definition-item">
                            <dt><span class="nds-label">hidden</span></dt>
                    ...
                    <dl class="nds-definition-list nds-tableView">
                        <div class="nds-definition-item">
                            <dt><span class="nds-label">No aria-hidden</span></dt>
                            <dd>Omit the attribute entirely (don't use aria-hidden="false")</dd>
                        </div>
                        <div class="nds-definition-item">
                            <dt><span class="nds-label">No hidden</span></dt>
                        ...
                        <div class="nds-definition-item">
                            <dt><span class="nds-label">aria-labelledby</span></dt>
