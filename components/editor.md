...
hero_description: A rich text editing field for user-authored content that submits clean NDS markup, converting pasted Word, Google Docs, and web content on the way in and accepting NDS component markup on paste.
breadcrumb: [["Components", "/components"]]
lang: en
direction: ltr
since: "1.4.0"
updated: "1.4.0"
last_edit: "17/07/2026 - 08:29 AM"
---
        ...
        <div class="nds-section-body">
            <div class="nds-definition-list nds-divided nds-grid nds-doc-features">
                ...
                <div class="nds-definition-item">
                    ...
                    <p class="nds-item-desc">Paste component markup from any doc page and it stays a styled, editable NDS component: classes, status attributes, and sizing knobs survive while unsafe markup is stripped.</p>
                </div>
                <div class="nds-definition-item">
                    <span class="nds-item-title">
                ...
                <div class="nds-definition-item">
                    ...
                    <p class="nds-item-desc">Initialize, create, and destroy instances, and react to the ready event through the JS API.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="nds-section-wrapper">
        ...
        <div class="nds-section-body">
            ...
            <div class="nds-block">
                ...
                <table class="nds-table nds-responsive">
                    ...
                    <tbody>
                        ...
                        <tr><td><code class="nds-inline-code lang-html">Enter</code></td><td>New paragraph</td></tr>
            ...
            <div class="nds-block">
                ...
                <p>The <strong>NDS.Editor</strong> API initializes editors and creates and destroys instances. The submitted value is always the hidden textarea, so reading and listening work like any form field.</p>
...
const inst = NDS.Editor.create(el);   // initialize one root; returns the instance, or null if the markup is incomplete
