...
- [x] S33 rubric rewritten (Filter switch surfaces, Content Switcher out). The run came back INCONCLUSIVE — see open list.
...
- [ ] **S33 solo re-probe** — the batch answer stayed at process level and never landed the Filter-switch mapping (S28 flattening precedent; grade only after the solo run).
