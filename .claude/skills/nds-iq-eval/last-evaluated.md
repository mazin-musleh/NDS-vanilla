...
- **Visual pass** — a clean console proves nothing about layout. Look at the page at desktop and mobile width: spacing present, every icon a glyph, sticky/width behavior real, dark mode correct, the page reading as one design. Measured is not seen — a probed width is reported as measured, never visually verified. **Cannot see the page? Take the first rung that works:**
