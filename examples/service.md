    ...
    <div class="nds-section-body">
                        ...
                        <div class="nds-content-block">
                            <div class="nds-block-item">
                                <ol>
                                    ...
                                    <li>From the sidebar menu, select the desired service category</li>
                                    <li>Fill in the required information and upload necessary documents</li>
                                    <li>Review your application and submit the request</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    <div class="nds-tab-panel" role="tabpanel" id="panel-2" aria-labelledby="tab-2" aria-hidden="true"
                        tabindex="-1" hidden="">
                        <p>Requirements content goes here</p>
                    </div>
                    <div class="nds-tab-panel" role="tabpanel" id="panel-3" aria-labelledby="tab-3" aria-hidden="true"
                        tabindex="-1" hidden="">
                        <p>Required documents content goes here</p>
                    </div>
                </div>
            </div>
        </div>
        <aside class="nds-sideinfo nds-card nds-stroke nds-shadow" aria-label="Service information" hidden>
            <dl class="nds-definition-list">
                ...
                <div class="nds-definition-item">
                    <dt>
                        <svg class="nds-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        <span class="nds-label">Service Fee</span>
                    </dt>
                    <dd>Free</dd>
                </div>
                <div class="nds-definition-item">
                ...
                <div class="nds-definition-item">
                    ...
                    <dd>
                        <a href="#user-guide" class="nds-btn nds-secondary nds-md">
                            <span class="nds-label">Download User Guide</span>
                        </a>
                    </dd>
                </div>
                <div class="nds-definition-item">
                    ...
                    <dd><a href="#user-guide" class="nds-primary">
                            <span class="nds-label">Service Level Agreement</span>
                        </a>
                    </dd>
                </div>
                <div class="nds-definition-item">
                    ...
                    <dd>
                        <address>
                            Unified Tel:
                            <a href="tel:19996" class="nds-primary">
                                <span class="nds-label">19996</span>
                            </a>
                            <br>
                            Ext: 1234
                            <br>
                            Email:
                            <a href="mailto:support@services.gov.sa" class="nds-primary">
                                <span class="nds-label">support@services.gov.sa</span>
                            </a>
                        </address>
                    </dd>
                </div>
                    ...
                    <div class="nds-card nds-stroke">
                        ...
                        <div class="nds-card-content">
                            ...
                            <div class="nds-card-tags">
                                <span class="nds-tag nds-blue nds-sm"><span class="nds-label">{{ service.system }}</span></span>
                                {% if service.most_used %}
                                <span class="nds-tag nds-green nds-sm"><span class="nds-label">Most Used</span></span>
                                {% endif %}
                            </div>
                        </div>
