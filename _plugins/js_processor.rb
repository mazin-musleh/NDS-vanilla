...
class JSProcessor
  def initialize
    ...
    @bundles = {
      'nds-main.min.js' => ['nds-navController.js', 'nds-fontLoading.js', 'nds-cityWeather.js', 'nds-timeDate.js','nds-calendar.js', 'nds-sidemenu.js', 'nds-share.js', 'nds-cookies.js', 'nds-numbers.js', 'nds-oneRowContent.js', 'nds-accordion.js', 'nds-tabs.js', 'nds-forms.js', 'nds-fileUpload.js', 'nds-code.js','nds-init.js']
    }
  end
