...
class JSProcessor
  def initialize
    ...
    @bundles = {
      'nds-main.min.js' => ['nds-core.js', 'nds-navController.js', 'nds-fontLoading.js', 'nds-cityWeather.js', 'nds-timeDate.js','nds-calendar.js', 'nds-sideMenu.js', 'nds-drawer.js', 'nds-share.js', 'nds-cookies.js', 'nds-numbers.js', 'nds-accordion.js', 'nds-tabs.js', 'nds-tables.js', 'nds-stepper.js', 'nds-swiper.js', 'nds-forms.js', 'nds-otp.js', 'nds-fileUpload.js', 'nds-code.js', 'nds-rating.js', 'nds-expandable.js', 'nds-breadcrumb.js', 'nds-dropmenu.js', 'nds-pagination.js', 'nds-ipv.js', 'nds-backdrop.js', 'nds-modal.js', 'nds-alert.js', 'nds-feedback.js', 'nds-filter.js', 'nds-user-feedback.js', 'nds-sideInfo.js', 'nds-autocomplete.js', 'nds-loader.js']
    }
