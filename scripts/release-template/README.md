...
- `_source/` — readable JS/SCSS source behind the minified bundles, the raw doc/template/example page sources, plus machine-readable catalogs in `_source/_data/content/`.
